...
class VictoryMenu:
    ...
    def __init__(self, menu_font: MenuFont, on_main_menu):
        ...
        victory_text = menu_font.create_text_surface("YOU WON! CONGRATULATIONS!").convert_alpha()
        self.scaled_victory_text = UIElement.scale_surface(victory_text, self.scale)
    ...
    def draw(self, surface: pygame.Surface):
        ...
        self.menu_font.render_text_surface_unscaled(surface, self.scaled_victory_text, (settings.SCREEN_WIDTH // 2 - self.scaled_victory_text.get_width() // 2, 50))
